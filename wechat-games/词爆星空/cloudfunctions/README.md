...
```json
{
  ...
  "diamonds": "number (默认3)",
  "energy": "number (默认30)",
  "maxEnergy": "number (默认30)",
  "highScore": "number (默认0)",
  "totalPlays": "number (默认0)",
...
{
  "_openid": "string",
  "gameName": "string (词爆星空|卷王冲冲冲|合成亿万达)",
  "score": "number",
  "createdAt": "date",
  "updatedAt": "date"
}
...
{
  "_openid": "string",
  "adType": "string (revive|hint|double|energy|signin)",
  "gameName": "string",
  "watchedAt": "date"
}
```
